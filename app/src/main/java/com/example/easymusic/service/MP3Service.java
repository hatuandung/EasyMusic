...
public class MP3Service extends Service {
    ...
    private void initRemoteViews() {
        remoteViews = new RemoteViews(getPackageName(), R.layout.ui_notification2);
        registerAction(R.id.img_close, ACTION_CLOSE);
        registerAction(R.id.img_next, ACTION_NEXT);
        registerAction(R.id.img_prev, ACTION_PREV);
    ...
    private void pushNotify(Song song) {
        ...
        remoteViews.setTextViewText(R.id.txt_song_notification, song.getTitle());
        remoteViews.setTextViewText(R.id.txt_artist_notification, song.getArtist());
